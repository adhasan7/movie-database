              ...
              <div className={styles.form__table}>
                ...
                <form onSubmit={hendleSubmit}>
                  ...
                  {/* jika isTitleError true maka akan memunculkan error
                             ...
                             */}
                  {isTitleError && (
                    <alert className={styles.keterangan}>
                      {" "}
                      text wajib diisi
                    </alert>
                  )}
                  ...
                  >
                    <option
                      ...
                      value=''
                    ></option>
                    <option className={styles.Wrapper__select} value='Action'>
                      Action
                    </option>
                    <option className={styles.Wrapper__select} value='Drama'>
                      Drama
                    </option>
                    <option className={styles.Wrapper__select} value='Horror'>
                      Horror
                    </option>
                    <option className={styles.Wrapper__select} value='Comedy'>
                      Comedy
                    </option>
                  </select>
                  ...
                  <button className={styles.button__input}>Kirim22222m</button>
                </form>
              </div>
            </div>
          </div>
